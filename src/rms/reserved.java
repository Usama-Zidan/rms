...
public void table()
        {
            try 
            {
                String sql = "SELECT tname AS Customer,tphone AS Phone,tid AS ID,tdate AS Date,ttime AS Time,tavai AS Availability,ttable AS TableNumber FROM rms.tableee ";
        ...
        public void update ()
        {
            ...
            try 
            {
                String sql = "UPDATE tableee SET tname = '"+name+"',tphone ='"+phone+"',tid ='"+id+"',tdate ='"+date+"',ttime ='"+time+"',ttable ='"+table+"',tavai ='"+avala+"' WHERE tname = '"+name+"'";
                sss = sos.prepareStatement(sql);
                sss.execute();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(420, 20, 40, 16);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(timebox, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 70, 850, 200);
        ...
        searchbox.setBounds(460, 10, 180, 30);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer", "Phone", "ID", "Date", "Time", "TableNumber", "Availability"
            }
        ) {
        ...
        jScrollPane1.setBounds(10, 300, 650, 190);
        ...
        iddttbox.setBounds(610, 0, 40, 20);
