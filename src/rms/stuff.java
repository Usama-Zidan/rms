 ...
 public void table()
        ...
        public void update ()
        {
          ...
          String date = sdf.format(datebox.getDate());
            ...
            try 
            {
                String sql = "UPDATE roles SET rname = '"+name+"',rposition ='"+position+"',rphone ='"+phone+"',rsection ='"+section+"',raddress ='"+address+"',rage ='"+age+"',rnic ='"+idnumber+"',rdate ='"+date+"' WHERE rname = '"+name+"'";
                sss = sos.prepareStatement(sql);
                sss.execute();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel6);
        jLabel6.setBounds(720, 30, 50, 16);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(phonebox, javax.swing.GroupLayout.DEFAULT_SIZE, 229, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createSequentialGroup()
